...
async def get_conversational_chain():
    prompt_template = """
    You are an expert in understanding invoices. We will upload pdfs as invoices, and you will have to answer any questions based on the uploaded invoice or invoices. Do not provide the wrong answer.\n\n
    Context: \n{context}?\n
    Question: \n{question}\n
